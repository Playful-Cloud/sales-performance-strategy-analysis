...
Using a structured analytics workflow — \*\*Data Validation → Exploratory Data Analysis → Strategy Evaluation\*\* — the project identifies which approach drives the strongest revenue performance and provides data-backed recommendations.
...
│   ├── 01\_data\_validation/   	# Exploratory Data Analysis

│   ├── 02\_eda/ 		# Data Cleaning and Transformation

│   └── 03\_analysis/     	# Data Analysis \& Statistical Testing
...
\*\*Notebook:\*\* `01\_data\_validation.ipynb`
...
\- Inconsistent formatting in `sales\_method`
...
| sales\_method | Outreach strategy used |

| customer\_id | Unique customer identifier |

| nb\_sold | Number of new products sold |

| revenue | Revenue generated |

| years\_as\_customer | Customer tenure |

| nb\_site\_visits | Website visits (last 6 months) |
